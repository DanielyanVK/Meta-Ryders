...
class HomeViewController: UIViewController {
    ...
    private var news: [News] = [
        News(title: "Coinbase is Partnering with MasterCard to Allow Card Pay", imageName: "news1", article: "Мох! Стать похожим меньше на цветок, больше на Мох! Японский сад промок, воду пьёт зелёный мох. Неприметным ковром стелется в тени цветов, репней и пестиков, шипов. Мы все исчезнем, но не мох.", timePosted: "1 hour ago", sourceName: "bloomberg.com"),
